...
#
# pestifer standalone VMD/TcL script
#
# run as:
#
# $ pestifer script <name-of-this-file>
#
...
mol new ../1-build-base/my_5vn3-670.psf
mol addfile ../1-build-base/my_5vn3-670.pdb
...
vmdcon -info "z-rot dPhi $dPhi then y-rot dTheta $dTheta to align axis of 6e8w"
